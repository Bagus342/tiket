 ...
 * @author ALEXIS
 */
public class Inputan_Admin extends javax.swing.JFrame {
    /**
     * Creates new form Inputan_Admin
     */
    public Inputan_Admin() {
        initComponents();
    ...
    private void UserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UserActionPerformed
               Input_User User = new Input_User();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inputan_Admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Inputan_Admin().setVisible(true);
            }
        });
    }
